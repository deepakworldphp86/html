...
class Data extends AbstractHelper
{
	...
	public function getEnable(){
		if($this->getStoreConfig('social/general/enable_instagram')) {
			return true;
		}
		return false;
	}
	public function getUserName(){
		return $this->getStoreConfig('social/general/user_name');
	}
	public function getClientId(){
		return $this->getStoreConfig('social/general/client_id');
	}
	public function getNumber(){
		return $this->getStoreConfig('social/general/number');
	} 
	public function getWidth(){
		if($this->getStoreConfig('social/general/width')) {
			return $this->getStoreConfig('social/general/width');
		}
		return '100';
	}
	public function getHeight(){
		if($this->getStoreConfig('social/general/height')) {
			return $this->getStoreConfig('social/general/height');
		}
		return '100';
	}
